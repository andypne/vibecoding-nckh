    ...
    async def run(self, force_hours: int = None) -> None:
        ...
        try:
            ...
            for lang in self.config.ai.languages:
                ...
                # Also save items as JSON for programmatic access
                items_path = self.storage.save_items_json(today, important_items, language=lang)
                self.console.print(f"💾 Saved {lang.upper()} items JSON to: {items_path}\n")
